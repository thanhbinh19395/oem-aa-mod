...
// datagram, and hands the raw frame to hud_feed_nav16_raw() (declared in
// hud.h) for decode + render. The functions below are that receiver's
// lifecycle + status surface, called from hud.cpp.
